...
Game: while (gameRunning) {
    ...
    while (enemyHealth > 0) {
        ...
        let options = await inquirer.prompt({
            ...
            choices: ["1. Attack", "2. Take health potion", "3. Running"]
        });
        if (options.ans === "1. Attack") {
            ...
            if (numHealthPotion > 0) {
                ...
                numHealthPotion--;
                console.log(`You use heath portion for ${healthPotionHealAmount}`);
                console.log(`You have now ${heroHealth} health`);
                console.log(`You have ${numHealthPotion} health potion left.`);
            }
            else {
                console.log(`You have no heath pottions left. Defeat enemy to get health potion`);
            }
        }
        else if (options.ans === "3. Running") {
            console.log(`You run away from ${enemy}`);
            continue Game;
        }
    }
    if (heroHealth < 1) {
        console.log(`You are out of battle because you are too weak.`);
        break;
    }
    ...
    if (randomNumber < healthPotionDropChance) {
        numHealthPotion++;
        console.log(`Enemy give you health potions.`);
    ...
    if (userOption.ans === "1. Continue") {
        console.log("You are continuwe on your Adventure");
    }
    else {
